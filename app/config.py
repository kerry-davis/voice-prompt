...
class Settings:
    ...
    partial_interval_ms: int = _int_env("STREAM_PARTIAL_INTERVAL_MS", 500)
    vad_silence_ms: int = _int_env("STREAM_VAD_SILENCE_MS", 700)
    whisper_model: str = _resolve_model(os.getenv("STREAM_MODEL_WHISPER", "tiny.en"))
